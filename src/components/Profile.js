                ...
                <div className="card-header">
                    <ul className="nav nav-tabs card-header-tabs bg-primary">
                        ...
                        <li className="nav-item ms-auto d-flex align-items-center">
                            <a className="nav-link text-dark fw-bold active" href="/Profile"><i className="bi bi-person-circle"></i>PROFILE</a>
                            <a className="nav-link text-dark fw-bold ms-1" href="/Cart"><i className="bi bi-cart"></i> CART</a>
                        </li>
                    </ul>
                </div>
            </div>
